                ...
                <div class="middle">
                    ...
                    ?>
                        <fieldset class="clearfix">
                            <p><span class="fa fa-user"></span><input type="text" name="username" id="inputusername"
                                    class="form-control" Placeholder="Nama Pengguna" required></p>

                            <p><span class="fa fa-lock"></span><input type="password" name="password" id="inputPassword"
                                    class="form-control" Placeholder="Kata Sandi" required></p>

                            <div>
                                <span style="width:48%; text-align:left;  display: inline-block;"><a class="small-text"
                                        href="<?php echo base_url('index.php/forgotpassword/FormEditPassword/')?>">Lupa
                                        Kata Sandi?</a></span>
                                <span style="width:50%; text-align:right;  display: inline-block;"><input type="submit"
                                        value="Masuk" class="btn btn-primary"></span>
                            </div>
                        </fieldset>
                    ...
                    <div class="logo">
                        <img src="<?php echo base_url('assets/img/logo2.png')?>"
                            style="margin-left: 50px; width: 250px; height: 150px;">
                        <div class="clearfix"></div>
                    </div>
                </div>
            </center>
