...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            foreach($produksi_darah as $result){
                $bulan[] = $result->bulan;
                $tahun[] = $result->tahun;
                $gol_a[] = $result->gol_a;
                $gol_b[] = $result->gol_b;
...
Highcharts.chart('grafik_donor', {
    ...
    series: [{
        name: 'Obat Batuk',
        data: [529, 704, 128, 475, 568, 42, 800, 551, 339, 438, 452, 455]

    }, {
        name: 'Obat Flu',
        data: [547, 738, 124, 483, 592, 455, 816, 516, 337, 474, 445, 448]

    }, {
        name: 'Obat Demam',
        data: [709, 902, 167, 570, 779, 565, 1020, 600, 441, 537, 608, 602]

    }, {
        name: 'Obat Diare',
        data: [140, 217, 40, 185, 159, 136, 226, 153, 86, 144, 133, 120]
...
<<!-- Core JS Files -->
    ...
    <script type='text/javascript' src="<?php echo base_url()?>assets/js/jquery-1.10.2.js" type="text/javascript">
    </script>
    <script type='text/javascript' src="<?php echo base_url()?>assets/js/bootstrap.min.js" type="text/javascript">
    </script>
