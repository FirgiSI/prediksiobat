...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
                ...
                <div class="container-fluid">
                            ...
                            $no=1;
                                 foreach ($permintaan_darah as $a) {
                                   echo "<tr>
                                            ...
                                            <td>$a->gol_ab</td>
                                            <td>
                                            <a href='".base_url()."index.php/admin/FormEditPermintaanDarah/".$a->id_permintaan."'>
                                            <center>Sunting</a>
                                            </td>
                                            <td>
                                            <a href='".base_url()."index.php/admin/AksiDeletePermintaanDarah/".$a->id_permintaan."'>
                                            <center>Hapus</a>
                                           </td>
                                        </tr>";
                                    $no++;
                    ...
                    <p align="center">
                        <a button type="button" class="btn btn-default"
                            href="<?php echo base_url() ?>index.php/admin/FormAddPermintaanDarah" role="button">Tambah
                            Data</a>
            ...
            <script>
            function print_l() {
                window.open("<?php echo base_url()?>index.php/admin/print_datapermintaandarah", "_blank");
