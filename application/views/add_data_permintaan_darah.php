            ...
            <div class="content">
                <div class="container-fluid">
                    <center>
                        <h2>TAMBAH DATA</h2>
                        <?php
                        echo form_open ("admin/AksiAddPermintaanDarah", array("class"=>"form-horizontal")); //admin/AksiAddPermintaanDarah dari controller
                    ...
                    ?>
                        <span style="width:10%; text-align:right;  display: inline-block;"><a class="small-text"
                                href="<?php echo base_url('index.php/admin/datapermintaandarah')?>">Batal</a></span>
                    </center>
                </div>
            </div>
        </div>
