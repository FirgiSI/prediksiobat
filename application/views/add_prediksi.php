                ...
                <div class="container-fluid">
                    ...
                    <div class="panel-footer modal_custom">
                        <div class="container">
                            ...
                            <form action="<?php echo base_url()?>index.php/mamdani/AksiAddPrediksi" role="form"
                                method="post">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kegiatan" id="form-elem-4" class="form-control"
                                                placeholder="Kegiatan <= 31" />

                                            <div class="form-group">
                                                <label for="form-elem-3">Pendonor Darah</label>
                                                <input type="text" name="pendonor" id="form-elem-3" class="form-control"
                                                    placeholder="Pendonor" />
                                            </div>

                                            <div class="form-group">
                                                <label for="form-elem-3">Kebutuhan Rumah Sakit</label>
                                                <input type="text" name="kebutuhan" id="form-elem-3"
                                                    class="form-control" placeholder="Kebutuhan" />
                                            </div>
                                            ...
                                            <div style="margin-left: -100px;" class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <span
                                                            style="width:10%; text-align:right;  display: inline-block;"><a
                                                                class="small-text"
                                                                href="<?php echo base_url('index.php/admin/dataprediksi')?>">Batal</a></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
