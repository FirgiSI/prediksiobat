        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <h3>Data Donor Darah UTD PMI Kabupaten Bandung April 2017 - Maret 2018</h3>
                    <table align="center" cellspacing="0" cellpadding="5" width="100%">
                        <thead>
                            ...
                            <th>
                                <center>Jumlah Donor</center>
                            </th>
                            <th>
                                <center>Gagal Donor</center>
                            </th>
                            <th>
                                <center>Berhasil Donor</center>
                            </th>
                            <th colspan="2">
                                <center>Aksi</center>
                            </th>
                        ...
                        <tbody>
                            <?php
                            $no=1;
                                 foreach ($donor_darah as $a) {
                                   echo "<tr>
                                            <td>$no</td>
                                            <td>$a->bulan</td>
                                            <td>$a->tahun</td>
                                            <td>$a->jumlah_donor</td>
                                            <td>$a->gagal_donor</td>
                                            <td>$a->berhasil_donor</td>
                                            <td>
                                            <a href='".base_url()."index.php/admin/FormEditDonorDarah/".$a->id_donor."'>
                                            <center>Sunting</a>
                                            </td>
                                            <td>
                                            <a href='".base_url()."index.php/admin/AksiDeleteDonorDarah/".$a->id_donor."'>
                                            <center>Hapus</a>
                                           </td>
                                        </tr>";
                                    $no++;
                    ...
                    <p align="center">
                        <a button type="button" class="btn btn-default"
                            href="<?php echo base_url() ?>index.php/admin/FormAddDonorDarah" role="button">Tambah
                            Data</a>
                        <a button type="button" class="btn btn-default" href="" role="button" onclick="print_l()">Cetak
                            Laporan</a>
                    </p>
                </div>
            </div>
            ...
            <script>
            function print_l() {
                window.open("<?php echo base_url()?>index.php/admin/print_datadonordarah", "_blank");
