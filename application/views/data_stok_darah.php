        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <h3>Data Stok Darah UTD PMI Kabupaten Bandung April 2017 - Maret 2018</h3>
                    <table align="center" cellspacing="0" cellpadding="5" width="100%">
                        <thead>
                            ...
                            <th>
                                <center>Golongan A</center>
                            </th>
                            <th>
                                <center>Golongan B</center>
                            </th>
                            <th>
                                <center>Golongan O</center>
                            </th>
                            <th>
                                <center>Golongan AB</center>
                            </th>
                            <th colspan="2">
                                <center>Aksi</center>
                            </th>
                            ...
                            $no=1;
                                 foreach ($stok_darah as $a) {
                                   echo "<tr>
                                            ...
                                            <td>$a->gol_ab</td>
                                            <td>
                                            <a href='".base_url()."index.php/admin/FormEditStokDarah/".$a->id_stok."'>
                                            <center>Sunting</a>
                                            </td>
                                            <td>
                                            <a href='".base_url()."index.php/admin/AksiDeleteStokDarah/".$a->id_stok."'>
                                            <center>Hapus</a>
                                           </td>
                                        </tr>";
                                    $no++;
                    ...
                    <p align="center">
                        <a button type="button" class="btn btn-default"
                            href="<?php echo base_url() ?>index.php/admin/FormAddStokDarah" role="button">Tambah
                            Data</a>
            ...
            <script>
            function print_l() {
                window.open("<?php echo base_url()?>index.php/admin/print_datastokdarah", "_blank");
