                ...
                <div class="container-fluid">
                    ...
                    <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <center>Kategori Obat</center>
                                </th>
                                <th>
                                    <center>Produksi</center>
                                </th>
                                <th>
                                    <center>Persediaan</center>
                                </th>
                                <th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a
                                        href="<?php echo base_url('index.php/mamdani/proses'.'/'.$a->id_prediksi);?>">Proses</a>
                                </td>
                                <td><a
                                        href="<?php echo base_url('index.php/admin/AksiDeletePrediksi'.'/'.$a->id_prediksi);?>">Hapus</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    ...
                    <p align="center">
                        <a button type="button" class="btn btn-default"
                            href="<?php echo base_url() ?>index.php/admin/FormAddPrediksi" role="button">Tambah Prediksi
                            &raquo;</a>
