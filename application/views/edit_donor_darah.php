        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <center>
                        <?php
                        echo form_open_multipart ("admin/AksiEditDonorDarah", array("class"=>"form-horizontal")); //admin/AksiEditDonorDarah dari controller
                           foreach ($donor_darah as $dm) {
                            ...
                            echo form_input(array("name"  => "tahun",
                                                  ...
                                                  "placeholder" => "Tahun",
                                                  "type"  => "text"));
                            echo form_input(array("name"  => "jumlah_donor",
                                                  "class" => "form-control",
                                                   "value" => $dm->jumlah_donor,
                                                  "placeholder" => "Jumlah Donor",
                                                  "type"  => "text"));
                            echo form_input(array("name"  => "gagal_donor",
                                                  "class" => "form-control",
                                                   "value" => $dm->gagal_donor,
                                                  "placeholder" => "Gagal Donor",
                                                  "type"  => "text"));
                            echo form_input(array("name"  => "berhasil_donor",
                                                  "class" => "form-control",
                                                   "value" => $dm->berhasil_donor,
                                                  "placeholder" => "Berhasil Donor",
                                                  "type"  => "text"));
                            echo form_input(array("name"  => "id_donor",                             
                                                  "value" => $dm->id_donor,                             
                                                  "type"  => "hidden"));
                    ...
                    ?>
                        <span style="width:10%; text-align:right;  display: inline-block;"><a class="small-text"
                                href="<?php echo base_url('index.php/admin/datadonordarah')?>">Batal</a></span>
                    </center>
                </div>
            </div>
        </div>
