                    ...
                    <div id="login">
                        ...
                        echo form_open_multipart("forgotpassword/AksiEditPassword", array("class"=>"form-horizontal"));      
                            ...
                            echo form_input(array("class" => "btn btn-success",
                                                  ...
                                                  "value" => "Submit"));
                    ?>
                        <span style="width:50%; text-align:right;  display: inline-block;"><a class="small-text"
                                href="<?php echo base_url('index.php/login')?>">Batal</a></span>
                    </div> <!-- end login -->
                    <div class="logo">
                        <img src="<?php echo base_url('assets/img/logo-pmi1.png')?>"
                            style="margin-left: 50px; width: 300px; height: 150px;">
