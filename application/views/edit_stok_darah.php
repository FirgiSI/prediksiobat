        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <center>
                        <?php
                        echo form_open_multipart ("admin/AksiEditStokDarah", array("class"=>"form-horizontal")); //admin/AksiEditStokDarah dari controller
                           foreach ($stok_darah as $dm) {
                            ...
                            echo form_input(array("name"  => "gol_ab",
                                                  ...
                                                  "type"  => "text"));
                            echo form_input(array("name"  => "id_stok",                             
                                                  "value" => $dm->id_stok,                             
                                                  "type"  => "hidden"));
                    ...
                    ?>
                        <span style="width:10%; text-align:right;  display: inline-block;"><a class="small-text"
                                href="<?php echo base_url('index.php/admin/datastokdarah')?>">Batal</a></span>
                    </center>
                </div>
            </div>
        </div>
